...
T1_CQM_URL							="http://sqe.t1.nat.bt.com/cqm"

#Common
#PROCESS_LOADING					="xpath=.//*[contains(text(),'Please wait')]"
PROCESS_LOADING						="xpath=.//div[contains(@class,'blockUI')]//span[contains(text(),'Loading')]"